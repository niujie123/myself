...
class Fn {
    ...
    {
        $refer = Yii::app() -> getRequest() ->urlReferrer ? Yii::app() -> getRequest() ->urlReferrer : FF_DOMAIN.$ru;
        $url = FF_DOMAIN.'/login/callback?referer='.$refer;
        return rawurlencode($url);
    }

    public static function url_login_current()
    {
        $url = FF_DOMAIN.Yii::app() -> getRequest() ->getUrl() ;
